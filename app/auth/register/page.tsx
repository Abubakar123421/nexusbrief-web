...
const STORY_TEASERS = [
  'Morning Briefing: Five Headlines Before 8 AM',
  'How AI Curation Is Reshaping Editorial Standards',
  'The Return of Long-Form: Why Depth Beats Speed',
  'Data Journalism and the New Information Economy',
  'Trust, Transparency, and the Future of the Press',
];

const REGISTER_QUOTES = [
  "“Your morning, curated. Five stories, every day.”",
  "“Stop scrolling. Start reading what matters.”",
  "“The signal in the noise of global news.”"
];
    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden md:flex w-1/2 min-h-screen flex-col justify-between p-12 relative overflow-hidden bg-[#0A0A0A]">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full w-full">
          ...
          {/* Editorial Quote */}
          <TypewriterText texts={REGISTER_QUOTES} />
        ...
        >
          ...
          <div className="mb-10">
            <h1 className="font-playfair font-black text-[42px] leading-[1.1] text-ink tracking-tight mb-4">
              Subscribe to <br /> The Digest.
            </h1>
            <p className="font-garamond text-[18px] text-ink/70 leading-relaxed max-w-[90%]">
              Join our readership to receive curated intelligence tailored precisely to your intellectual pursuits.
            </p>
          </div>
          ...
          <AnimatePresence>
            {successMessage && (
              ...
              >
                <div className="font-garamond italic text-[17px] text-[#1A5C2A] border-l-2 border-[#1A5C2A] pl-4 py-1">
                  {successMessage}
                </div>
              </motion.div>
            )}
            ...
            <form onSubmit={handleSignUp} noValidate className="space-y-6">
              ...
              <div className="relative group">
                ...
                <label
                  ...
                  style={{ top: name ? '-16px' : '8px', fontSize: name ? '9px' : '11px', color: name ? '#0A0A0A' : 'rgba(10,10,10,0.5)' }}
                >
                  Full Name
                </label>
              </div>
              ...
              <div className="relative group pt-3">
                ...
                <label
                  ...
                  style={{ top: email ? '0px' : '20px', fontSize: email ? '9px' : '11px', color: email ? '#0A0A0A' : 'rgba(10,10,10,0.5)' }}
                >
                  Email Address
                </label>
              </div>
              ...
              <div className="flex gap-6 pt-3">
                ...
                <div className="relative group flex-1">
                  ...
                  <label
                    ...
                    className="absolute left-0 font-montserrat text-[11px] uppercase tracking-[0.15em] text-ink/50 transition-all duration-300 peer-focus:-top-4 peer-focus:text-[9px] peer-focus:text-ink peer-valid:-top-4 peer-valid:text-[9px]"
                    style={{ top: password ? '-16px' : '8px', fontSize: password ? '9px' : '11px', color: password ? '#0A0A0A' : 'rgba(10,10,10,0.5)' }}
                  >
                    Password
                  </label>
                </div>
                ...
                <div className="relative group flex-1">
                  ...
                  <label
                    ...
                    className="absolute left-0 font-montserrat text-[11px] uppercase tracking-[0.15em] text-ink/50 transition-all duration-300 peer-focus:-top-4 peer-focus:text-[9px] peer-focus:text-ink peer-valid:-top-4 peer-valid:text-[9px]"
                    style={{ top: confirmPassword ? '-16px' : '8px', fontSize: confirmPassword ? '9px' : '11px', color: confirmPassword ? '#0A0A0A' : 'rgba(10,10,10,0.5)' }}
                  >
                    Confirm
                  </label>
                </div>
